...
class TraineeshipsController < ApplicationController
  ...
  private
    ...
    def traineeship_params
      params.require(:traineeship).permit(:ep_name, :tn_type, :home_lc, :lc_comments, :ep_email, :manager_name, :manager_email, :region, :country, :lc, :rate_homelc, :tn_name, :start, :end, :rate_lc, :rate_tn, :tn_comments, :aiesec_comments, :homelc_comments, :visa, :cultural)
    end
end
